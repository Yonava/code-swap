...
exports.listenToChannel = exports.logResponse = exports.logRequest = exports.pubSubLogger = void 0;
...
const listenToChannel = (args) => sub.subscribe(args.from, async (message) => {
    try {
        (0, exports.logRequest)({ channel: args.from, payload: message });
        const parsedMessage = JSON.parse(message);
        const result = await args.fn(parsedMessage);
        if (args.replyTo && result) {
            const payload = JSON.stringify(result);
            (0, exports.logResponse)({ channel: args.replyTo, payload });
